...
homicide_df
```
The raw data contains `r nrow(homicide_df)` homicide records across 50 U.S. cities. Each row corresponds to a single victim and includes variables such as name, age, race, sex, city, state, latitude/longitude, and disposition. The key variable of interest is `disposition`, which indicates whether the homicide was solved or unsolved.
